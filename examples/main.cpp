...
#undef X
    ...
    // training
    nn.train<mse>(optimizer, train_images, train_labels, minibatch_size, 1, on_enumerate_minibatch, on_enumerate_epoch);
...
void sample2_mlp()
{
    ...
    nn.train<mse>(optimizer, train_images, train_labels, 20, 20, on_enumerate_data, on_enumerate_epoch);
}
...
#else
    cout << "relu" << endl;
    auto nn = make_mlp<relu>({ 100, 400, 100 });
#endif
